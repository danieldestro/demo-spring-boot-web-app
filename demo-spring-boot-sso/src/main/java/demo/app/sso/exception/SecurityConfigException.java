package demo.app.sso.exception;

/**
 * Custom Exception which can be thrown in place of the Generic java.lang.Exception class
 */
public class SecurityConfigException extends Exception {

    private static final long serialVersionUID = 3345943952029685023L;
     ...
     */
    protected SecurityConfigException(String message, Throwable cause,
